...
class Main_Ui(QWidget):
    ...
    def set_above_right_layout(self):
        ...
        self.show_door_state_label = self.set_label('车门状态','r')
        self.show_crowd_counted_label = self.set_label('车内人数','r')
        self.show_crossline_counted_label = self.set_label('下车总人数','r')
        self.show_crossline_sum_counted_label = self.set_label('当前下车人数','r')
